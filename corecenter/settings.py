"""
Django settings for corecenter project.
...
SECRET_KEY = 'django-insecure-z$$96yq*rw(c$uc5m+%hh8%$(-dod7=(oux4kw5%1#$y8ulu=l'
...
WSGI_APPLICATION = 'corecenter.wsgi.application'
